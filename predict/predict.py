...
data_dir='/data4/ads_dm/hanxu8/DeepFm/predict/tmp_hx_ctr_train_feas'
...
with tf.Session() as sess:
    # 导入模型
    saver = tf.train.import_meta_graph("/data4/ads_dm/hanxu8/DeepFm/model/model.ckpt-14876.meta", clear_devices=True)
    saver.restore(sess, '/data4/ads_dm/hanxu8/DeepFm/model/model.ckpt-14876')
